...
<table>  
    ...
    <tr>
        ...
        <td>:</td>
        <td>
            <asp:Textbox ID="txtMateriID" runat="server"></asp:Textbox>
        </td>
    </tr>
    <tr>  
        ...
        <td>:</td>  
        <td>  
            <asp:TextBox ID="txtMataPelajaran" runat="server"></asp:TextBox>  
        </td>  
    </tr>  
    <tr>  
        <td>Materi</td>  
        <td>:</td>  
        <td>  
            <asp:TextBox ID="txtMateri" runat="server"></asp:TextBox>  
        </td>  
    </tr>  
